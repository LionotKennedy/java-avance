...
public class TextFieldDefaultBackground extends JTextField {
    ...
    private Color defaultBackground = Color.WHITE; // Couleur d'arrière-plan par défaut
//    private Color background = new Color(60, 63, 65);
    private Color background = new Color(242, 242, 242);

    public TextFieldDefaultBackground() {
...
//        g2.setColor(defaultBackground); // Remplir avec la couleur d'arrière-plan par défaut
        g2.setColor(background); // Remplir avec la couleur d'arrière-plan par défaut
    ...
    public void setDefaultBackground(Color defaultBackground) {
        ...
        TextFieldDefault textField = new TextFieldDefault();
        textField.setDefaultBackground(Color.YELLOW); // Définir la couleur d'arrière-plan par défaut
